package com.academy.naveenautomationlabs.util;
...
public class XmlParser {
    ...
    public static List<Element> getElements(String xmlString, String xpathString) {
        ...
        try {
            ...
            throw new RuntimeException("The XML string is invalid::\n" + xmlString);
        }
    ...
    public static XPathExpression getXPathExpression(String xpathString) {
        ...
        try {
            ...
            throw new RuntimeException("The XPath is invalid::\n" + xPath);
        }
    }
    ...
    public static InputSource getInputSource(String xmlString) {
        ...
        try {
            ...
            throw  new RuntimeException("The string could not be encoded to UTF-8::\n" + xmlString);
        }
    ...
    public static void main(String[] args) throws IOException {
        ...
        try {
            String contents = new String(Files.readAllBytes(Paths.get("src/test/resources/xml/sample-catalog.xml")));
            System.out.println(contents + "\n");

            XmlParser xp = new XmlParser(contents);

            String item = xp.getTextContent("//catalog/product//catalog_item//item_number");
            System.out.println("Item Number: " + item);

            List<Element> itemList = xp.getElements("//catalog/product//catalog_item//item_number");
            System.out.println("Item Size: " + itemList.size());

            System.out.print("Item Numbers: ");
            for (int i = 0; i < itemList.size(); i++) {
                System.out.print(itemList.get(i).getTextContent() + " ");
            }
            System.out.println();
